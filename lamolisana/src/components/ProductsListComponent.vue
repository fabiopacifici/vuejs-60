<template>
  ...
  <div class="products">
    <div class="container">
      <div class="row">
        <Product   :src="pasta.src" :titolo="pasta.titolo"  v-for="pasta in products" :key="pasta.titolo"/>
        <!-- Passando unica prop come un oggetto 
          <Product   :pasta="pasta" v-for="pasta in products" :key="pasta.titolo"/> -->
